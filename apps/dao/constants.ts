...
export const safes = [
  {
    baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.ETHEREUM}/safes`,
    name: 'Ops',
    chainId: ChainId.ETHEREUM,
    address: '0x19B3Eb3Af5D93b77a5619b047De0EED7115A19e7',
  },
  {
    baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.POLYGON}/safes`,
    name: 'Fees',
  ...
  {
    baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.XDAI}/safes`,
    name: 'Ops',
  ...
  {
    baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.BINANCE}/safes`,
    name: 'Ops',
    chainId: ChainId.BINANCE,
    address: '0xc6fD91aD4919Fd91e2c84077ba648092cB499638',
  },
  {
      baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.AVALANCHE}/safes`,
      name: 'Ops',
      chainId: ChainId.AVALANCHE,
      address: '0x09842Ce338647906B686aBB3B648A6457fbB25DA',
    },
    {
      baseUrl: `https://client-gateway.celo-safe.io/v1/chains/${ChainId.CELO}/safes`,
      name: 'Ops',
  ...
  {
    baseUrl: `https://safe-client.gnosis.io/v1/chains/${ChainId.ARBITRUM}/safes`,
    name: 'Ops',
  ...
  // FIXME: 1.20
  // {
  //   baseUrl: 'https://multisig.harmony.one/#/safes',
  //   name: 'Ops',
...
// FIXME: redux store?
  // {
  //   baseUrl: 'https://safe.fuse.io/fuse:',
  //   name: 'Ops',
  //   chainId: ChainId.FUSE,
  //   address: '0x33b6beb37837459Ee84a1Ffed2C6a4ca22e5F316',
  // },
  
  // TODO: stores it in redux?
  // {
  //   baseUrl: 'https://multisig.moonbeam.network/mriver:',
  //   name: 'Fees',
  ...
  // TODO: stores it in redux?
  // {
  //   baseUrl: 'https://safe.fantom.network/#/safes/',
  //   name: 'Ops',
